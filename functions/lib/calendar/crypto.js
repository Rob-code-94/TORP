...
export function encryptToken(plain, base64Key) {
...
export function decryptToken(blobB64, base64Key) {
    const key = readKey(base64Key);
...
export function hmacBase64Url(payload, base64Key) {
 ...
 */
export function newFeedToken(uid) {
